  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      <button
        ...
        disabled={disabled}
        className={`w-full px-3 py-2 text-left text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${
          disabled
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <span className={`truncate ${selectedOption ? 'text-sm' : 'text-sm text-gray-500 dark:text-gray-400'}`}>
