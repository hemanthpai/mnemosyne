...
const NotesPage: React.FC = () => {
  ...
  const handleClearAllData = async () => {
    if (!confirm('Are you sure you want to clear ALL data? This will delete all conversations, notes, and vectors. Settings will be preserved.')) {
      return;
    }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md mb-6">
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-12 gap-3">
                ...
                {/* Stats and Actions */}
                <div className="col-span-2 sm:col-span-1 lg:col-span-7 flex items-end justify-between">
